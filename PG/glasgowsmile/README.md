...
> The directories permisions seemed abit unusual that it only had read permisions. We  fix that by changing permisions recursively for the directory to have all perms.
